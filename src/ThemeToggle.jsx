...
import { getSettings, saveSettings } from '../engine/progress.js'
...
export default function ThemeToggle() {
  ...
  return (
    <button
      type="button"
      className="flex h-11 w-11 items-center justify-center rounded-full bg-origen-cream text-origen-carbon transition hover:bg-origen-mostaza/20 dark:bg-slate-800 dark:text-slate-400 dark:hover:bg-slate-700"
      onClick={toggle}
      title="Toggle theme"
    >
      {theme === 'dark' ? (
